...
Emit each marker line only once. Put NOTHING after the end-marker line. You are READ-ONLY: create the documents listed above in the zaifu repo, then report what you created in the handoff between the markers.
